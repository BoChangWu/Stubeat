...
// I 0.got this by sorting the average sigmas for each dimension, after encoding
...
async function play(event, playerIndex) {
    let player, mel;
    console.log(mm.sequenceProtoToMidi(currentSample))
    // console.log(currentSample.notes)
    // $("#dataContent").html(currentSample)
